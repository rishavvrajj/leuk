...
export default async function PortfolioPage({ params }: Props) {
  ...
  return (
    <main className="flex-1 bg-zinc-950 px-6 text-zinc-100">
      <div className="mx-auto w-full max-w-3xl border border-zinc-800/60">
        ...
        {/* Identity & Header */}
        <header className="flex items-start gap-6 p-4 border border-zinc-800/60">
          <Image
            ...
            height={80}
            priority
            className="h-16 w-16 sm:h-20 sm:w-20 rounded-md border border-zinc-800/80 object-cover shrink-0"
          />
          <div className="flex-1 min-w-0">
            ...
            <div className="flex space-x-4">
              {portfolio.name && (
                <a
                  ...
                  className="mt-1 cursor-pointer inline-block text-sm font-mono text-zinc-400 hover:text-zinc-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 rounded"
                >
                  @{portfolio.username}
                </a>
              )}
              {(portfolio.company || portfolio.location) && (
                <div className="mt-1 cursor-pointer space-x-2 text-sm font-mono text-zinc-400 hover:text-zinc-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 rounded">
                  {portfolio.company && (
            ...
            {portfolio.bio?.trim() && (
              <span>
                <p className="mt-1 cursor-pointer text-sm font-mono text-zinc-400 hover:text-zinc-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 rounded">
                  {portfolio.bio}
                </p>
              </span>
            )}
